                        ...
                        <form role="form" method="post"
                            ...
                            <input type="hidden" name="_token" value="{{ csrf_token() }}">
                                    ...
                                    <div class="form-group title" >
                                        ...
                                        name="title_in_english" required placeholder="Title in English">
                                    </div>
                                    <div class="form-group title" >
                                        <label>Title in Arabic</label>
                                        <input type="text" class="form-control titles"
                                        name="title_in_arabic" required placeholder="Title in Arabic">
                                    </div>
                                    <div class="form-group body">
                                        <label>Text in English</label>
                                        <textarea class="form-control text"
                                        name="text_in_english" required></textarea>
                                    </div>
                                    <div class="form-group body">
                                        <label>Text in Arabic</label>
                                        <textarea class="form-control text"
                                        name="text_in_arabic" required></textarea>
                                    </div>
